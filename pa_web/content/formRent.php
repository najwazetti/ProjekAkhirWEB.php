...
<div class="form-rent">
    <div class="container">
        <h2>BlueBird</h2>
        <p>Rent Bus</p>
        <form action="config\functions.php" class="form form-pesanan" method="post" id="rent-form">
            ...
            $conn->close();
            ?>
            <button name="masukan-rent" class="btn-submit" type="submit">Rent Now</button>
        </form>
    </div>
</div>
